export default {
    ...
    UPLOADYOUR:'Upload your photos',
    INORDERTOPUBLISH:'In order to publish, you need to give OLX permission to/n activeate your camera and photo gallery ',
    GIVEPERMISSION:'Give permission',
    SELECTPHOTOS:'Selected photos',
